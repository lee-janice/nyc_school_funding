...
- [Background](#background)
    ...
    - [Goals of this analysis](#goals-of-this-analysis)
    - [Data quality](#data-quality)
        - [Missingness in PTA reporting](#missingness-in-pta-reporting)
        - [Ending balance discrepancies](#ending-balance-discrepancies)
        - [Other data quality issues](#other-data-quality-issues)
    - [Final analytic sample](#final-analytic-sample)
- [Analytical results](#analytical-results)
    ...
    - [Socioeconomic & demographic stratification](#socioeconomic-and-demographic-stratification)
        - [Caveat: comparison with total funding amounts](#caveat-comparison-with-total-funding-amounts)
